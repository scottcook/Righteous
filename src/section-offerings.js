...
export function initOfferingsScroll() {
    const section = document.querySelector('.section-offerings');
    if (!section) return;

    console.log('Initializing scroll animation for .section-offerings');
